...
const CLAIMS: TrustClaim[] = [
  ...
  },
  {
    ...
    body: 'The result is a calibrated screening score and risk band, with an uncertainty state. A blood test is the real answer.',
  },
]
      ...
      <div className="mx-auto w-full max-w-6xl px-6 lg:px-10">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          ...
          <p className="max-w-sm text-sm leading-relaxed text-muted-foreground">
            The result comes from the calibrated V4 model on our server. The image is processed
            transiently; the browser never invents a fallback medical score.
          </p>
        </div>
      </div>
